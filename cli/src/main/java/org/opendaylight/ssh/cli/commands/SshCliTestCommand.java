 ...
 */
package org.opendaylight.ssh.cli.commands;
...
public class SshCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SshCliTestCommand.class);
    protected final SshCliCommands service;

    public SshCliTestCommand(final SshCliCommands service) {
